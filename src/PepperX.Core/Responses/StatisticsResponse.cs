namespace PepperX.Core.Responses
{
    ...
    public class StatisticsResponse
    {
        ...
        /// <summary>
        /// Total number of active objects across all containers.
        /// </summary>
        ...
        /// <summary>
        /// Per-container rollups. Never null.
        /// </summary>
        ...
        /// <summary>
        /// Total capacity of the storage volume in bytes, when reported by the driver.
        /// </summary>
        public long StorageTotalBytes { get; set; } = 0;

        /// <summary>
        /// Free capacity of the storage volume in bytes, when reported by the driver.
        /// </summary>
        public long StorageFreeBytes { get; set; } = 0;

        /// <summary>
        /// Approximate size of the metadata database in bytes.
        /// </summary>
        public long DatabaseSizeBytes { get; set; } = 0;

        /// <summary>
        /// Cluster nodes and their liveness. Never null.
        /// </summary>
