namespace PepperX.Core.Responses
{
    ...
    /// <summary>
    /// Result of writing (creating or replacing) an object.
    /// </summary>
    public class ObjectWriteResponse
    {
        ...
        /// <summary>
        /// Whether the write replaced an existing object (true) or created a new one (false).
        /// </summary>
        ...
        /// <summary>
        /// Instantiate an object write response.
        /// </summary>
